...
function(Doxygen target input)
  ...
  set(DOXYGEN_OUTPUT_DIRECTORY ${PROJECT_BINARY_DIR}/doc) # I added
  set(DOXYGEN_GENERATE_HTML YES)
  set(DOXYGEN_HTML_OUTPUT   ${DOXYGEN_OUTPUT_DIRECTORY}) # I added
...
macro(UseDoxygenAwesomeExtensions)
  ...
  # execute_process(COMMAND sed -i "/<\\/head>/r ${PROJECT_SOURCE_DIR}/cmake/doxygen_extra_headers" header.html
  #                 WORKING_DIRECTORY ${PROJECT_BINARY_DIR})
  set(DOXYGEN_HTML_HEADER ${DOXYGEN_OUTPUT_DIRECTORY})
